...
const Classic = () => {
  return (
    <section id='classic'>
      <div className='custom_flexContainer pt-16 relative overflow-hidden xl:pt-20 xl:max-w-7xl xl:mx-auto xl:px-4'>
        <div
          className='w-full pt-4 flex items-center justify-center xl:w-8/12 xl:pt-20'
          data-aos='zoom-in'
        ...
        <div className='custom_homeSection'>
          <div className='flex flex-col gap-6 xl:gap-8'>
            ...
            <div
              ...
              data-aos-offset='150'
            >
              <Image src={classicFull} alt='Cruiser' />
            </div>
