...
// images
import classicBikeWeb from '../../public/Classic/classic-black.webp';
import classicBikeMobile from '@/public/Classic/classic-black_hero-cropped.webp';

// icons
import { ArrowDownIcon } from '@heroicons/react/20/solid';

const ClassicBikeHero = () => {
  return (
    <div className='relative overflow-hidden pt-8 xl:h-[95vh]'>
      <div className='flex flex-col justify-center items-center gap-14'>
        ...
        >
          <Image src={classicBikeMobile} alt='Classic E-bike' />
        </div>
...
export default ClassicBikeHero;
